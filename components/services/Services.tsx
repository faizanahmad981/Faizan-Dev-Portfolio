      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div
          ...
          className={`
            ...
            ${headerReveal.show ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-10"}
          `}
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service: Service, index) => {
            const reveal = useReveal(0.25 + index * 0.1); // staggered cards
            ...
            return (
              <div
                ...
                ref={reveal.ref}
                className={`
                  group relative bg-[rgb(var(--bg-gray))]
                  ...
                  hover:-translate-y-3
                  hover:shadow-[0_25px_50px_rgba(46,255,193,0.25)]
                `}
              >
                {/* Top Gradient Line */}
                <span
                  className="
                    absolute top-0 left-0 w-0 h-1 rounded-t-xl
                    bg-gradient-to-r from-[rgb(var(--secondary-color))]
